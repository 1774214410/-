...
,	setPanePosition = function (panes) {
		...
		$.each(panes, function (i, pane) {
			...
			// set css-position to custinfo for container borders & padding
			switch (pane) {
...
,	sizeHandles = function (evt_or_panes) {
		...
		$.each(panes, function (i, pane) {
			...
			if (dir === "horz") { // north/south
				...
				$R.css({
					width:	cssW($R, paneLen) // custinfo for borders & padding
				...
				s.resizerLength = paneLen;
				$R.css({
					height:	cssH($R, paneLen) // custinfo for borders & padding
			...
			if ($T) {
				...
				if (dir === "horz") { // north/south
					...
					$T.css({
						width:	width  // custinfo for borders & padding
...
//					});
					...
					$T.css({
						height:	height // custinfo for borders & padding
...
,	write: function (name, val, cookieOpts) {
		...
		if (o.domain)	params += ";hundsun="+ o.domain;
